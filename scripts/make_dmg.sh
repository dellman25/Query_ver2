...
cd "$(dirname "$0")/.."
APP_PATH="dist/Query.app"
DMG_PATH="dist/Query.dmg"
...
hdiutil create -volname "Query" -srcfolder "$STAGING_DIR" -ov -format UDRW "$TEMP_DMG"
...
tell application "Finder"
  tell disk "Query"
    ...
    set position of item "Query.app" of container window to {120, 150}
